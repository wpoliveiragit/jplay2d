...
public class Parallax {
	 ...
	 * @param axisX        - 'true' to move the X axis and 'false to move on the y
	 *                     axis.
	 */
	...
	public void setVelAllLayers(double velMainLayerX, double velMainLayerY) {
		...
		mainLayer.setVel(velMainLayerX, velMainLayerY); // velocidade na camada principal (camada da frente, ou seja, a
														// ultima a ser pintada).
